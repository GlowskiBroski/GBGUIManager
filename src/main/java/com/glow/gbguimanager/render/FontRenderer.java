...
import com.glow.gbguimanager.baselib.action.OnChange;
import com.glow.gbguimanager.render.texture.TextureUtil;
    ...
    public void drawDynamicString(GuiGraphics graphics, String text, Vector pos, Color color) {
        ...
        for (char c : text.toCharArray()) {
            ...
            if (bakedDynamicCharList.containsKey(c)) {
                ...
                resourceLocation = ResourceLocation.fromNamespaceAndPath("gbguimanager", UUID.randomUUID().toString());
